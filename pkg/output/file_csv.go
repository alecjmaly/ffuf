...
var staticheaders = []string{"url", "redirectlocation", "position", "status_code", "content_length", "content_words", "content_lines", "resultfile", "response_time"}
...
func toCSV(r Result) []string {
	...
	res = append(res, strconv.FormatInt(r.ResponseTime, 10))
	return res
}
